...
////        world.getObstacles().add(new TextWorld());
////        world.getObstacles().add(new TextWorld(-10, -10));
//
...
////        assertTrue(robot1.getName().contains("Robot1"));
////        assertTrue(robot1.getName().contains("Robot2"));
////        assertTrue(robot1.getPosition().contains("(5,5)"));
////        assertTrue(robot1.getPosition().contains("(-10,-10)"));
//    }
//}
